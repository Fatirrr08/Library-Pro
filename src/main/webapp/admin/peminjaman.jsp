...
<div class="main-content">
    ...
    <div class="dashboard-content">
        <div class="welcome">
            ...
            <p>Otorisasi permintaan sirkulasi buku baru serta pantau denda keterlambatan (Batas 14 Hari, Rp 2.000/hari, denda dibayarkan di loket penjaga perpustakaan).</p>
        </div>
